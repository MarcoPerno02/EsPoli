...
implements Tool {
  ...
  int numberOfReducers, numberOfReducers2;
  int exitCode;  
  ...
  inputPath = new Path(".\\data\\JobOffers.txt");
  // Output folder
  outputDir1 = new Path(".\\out1");
  outputDir2 = new Path(".\\out2");
  ...
  job.setMapOutputValueClass(Offer.class);
