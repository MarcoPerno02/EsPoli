...
SVC_Handler     PROC
				...
				MOV R8, R0 ; Psp's ddress
				STMFD SP!, {R4-R11, LR}
				CMP LR, #0xFFFFFFFD ; Check if psp
				...
				; your code here
				;n R0 contains 0x5 00000101
				MOV R2, #8
				MOV R3, #1
				MOV R5, #0 ; Result register
				MOV R6, #23 ; Index used to iterate

loop			TST R0, R3, LSL #7
				LSL R0, R0, #1
				MOVEQ R4, #0
				MOVNE R4, #1
