...
Sort_BestTimes
        MOV R5, #0                ; R5 è l'indice per l'ordinamento di Best_times

Outer_BestTimes_Loop
        CMP R5, R3
        BGE Done_BestTimes_Sort   ; Esci dal loop esterno se completato
        MOV R6, R5                ; R6 è l'indice interno
...
Inner_BestTimes_Loop
        ...
        BGT Swap_BestTimes        ; Se il valore attuale è maggiore, esegui swap
        B No_Swap_BestTimes
...
Swap_BestTimes
        ...
        STR R10, [R7]             ; Memorizza l'ID del giorno più grande nella posizione attuale
        STR R8, [R9]              ; Memorizza l'ID del giorno più piccolo nella posizione di confronto
...
Done_BestTimes_Sort
        ...
        LDR R11, [R0, #24]        ; Il peggior best time sarà alla fine
		B Sort_FailedRuns
...
Sort_FailedRuns
        MOV R5, #0                ; R5 è l'indice per l'ordinamento di Failed_runs
...
Inner_FailedRuns_Loop
        ...
        BGT Swap_FailedRuns       ; Se il valore attuale è maggiore, esegui swap
